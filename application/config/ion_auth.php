 ...
 */
$config['site_title']                 = "Ade Muchlis";       // Site Title, example.com
$config['admin_email']                = "ades.anwari@gmail.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 60000;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['lockout_time']               = 5;                 // The number of seconds to lockout an account due to exceeded attempts
...
'smtp_user' => 'ades.anwari@gmail.com', // actual values different
'smtp_pass' => 'ademuchlis',
'smtp_port' => 465,
'newline' => "\r\n",
'charset' => 'utf-8'
);
