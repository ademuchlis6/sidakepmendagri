...
<h4>Dibawah ini adalah informasi kamu</h4>
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            <td>Jabatan</td>
            <td><?php echo $tingkatUserNama;?></td>
        </tr>
        <tr>
            <td>Lembaga</td>
            <td><?php echo $lembagaUserNama;?></td>
        </tr>
        <tr>
            <td>Subdirektorat</td>
            <td><?php echo $subUserNama;?></td>
        </tr>
        <tr>
            <td>Seksi</td>
            <td><?php echo $seksiUserNama;?></td>
        </tr>
    </tbody>
</table>


<h4>Data Pegawai Kementrian dalam negeri</h4>
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control" id="pilihLembaga">
                <option value="<?php echo $lembagaUser?>"><?php echo $lembagaUserNama?></option>
            </select>
        </div>
    </div>
    <div class="col-md-3">
...
function tableUsers() {
    ...
    let sub;
    sub = '<?php echo $this->ion_auth->user()->row()->subdirektorat;?>';
    let seksi;
    seksi = '<?php echo $this->ion_auth->user()->row()->seksi;?>';
        ...
        table = $('#tableUsers').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('users/usersRead')?>" + "?idLembaga=" + idLembaga +
                    "&idTingkat=" + idTingkat + "&sub=" + sub + "&seksi=" + seksi,
                "type": "POST"
            },
                ...
                <form action="#" id="formPegawai" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" id='subShow' style="display:none">
                            ...
                            <div class="col-md-9">
                                <select name="subDirektorat" class="form-control">
                                    <option value="<?php echo $subUser;?>"><?php echo $subUserNama;?></option>
                                </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id='seksiShow' style="display:none">
                            ...
                            <div class="col-md-9">
                                <select name="seksi" class="form-control">
                                    <option value="<?php echo $seksiUser;?>"><?php echo $seksiUserNama;?></option>
                                </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
