...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.link').on('click', '.ajaxify', function (e) {
            e.preventDefault();
            App.scrollTop();
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            if (options.iconOnly) {
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><div class="loader"></div><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><div class="loader"></div>&nbsp;&nbsp;<span>' + (message ? message : 'Loading...') + '</span></div>');
        },
